...
final class Version20251021170313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE jeu_video (id INT AUTO_INCREMENT NOT NULL, editeur_id INT NOT NULL, genre_id INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, developpeur VARCHAR(255) NOT NULL, date_sortie DATE DEFAULT NULL, prix NUMERIC(6, 2) DEFAULT NULL, description LONGTEXT DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_4E22D9D43375BD21 (editeur_id), INDEX IDX_4E22D9D44296D31F (genre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
